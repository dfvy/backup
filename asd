...
function Lib:CreateWindow(Name)
    ...
    Main.ImageColor3 = Color3.fromRGB(1, 1, 1)
    ...
    glow.BackgroundTransparency = 900
    ...
    glow_2.BackgroundTransparency = 900
    glow_2.BorderSizePixel = 1
